...
function bo(e, n, t, r) {
  if (Dr) {
    var l = co(e, n, t, r);
    if (l === null) Ml(e, n, r, Fr, t), Yi(e, r);
...
var it = {
  ...
  Zi = we(tl),
  lf = B({}, tl, { dataTransfer: 0 }),
  of = we(lf),
  uf = B({}, Zt, { relatedTarget: 0 }),
  Pl = we(uf),
  sf = B({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = we(sf),
  cf = B({}, it, {
...
var yf = B({}, Zt, {
  ...
  kf = we(Sf),
  Ef = B({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  xf = we(Ef),
  Cf = B({}, tl, {
    deltaX: function (e) {
...
function hn() {
  if (!Fl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), xs(Zo, hn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function ii(e) {
  for (; e === Br; )
    (Br = Vn[--Bn]), (Vn[Bn] = null), (Ar = Vn[--Bn]), (Vn[Bn] = null);
  for (; e === Nn; )
    (Nn = Se[--ke]),
      (Se[ke] = null),
      (Ae = Se[--ke]),
...
function pi(e, n) {
  switch ((M(Ht, n), M(At, e), M(Ue, qt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function ka(e, n, t) {
  return Pn & 21
    ? (Oe(t, n) || ((t = Ns()), (V.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function nd(e, n, t) {
  ...
  if (xa(e)) Ca(n, l);
    ...
    (t = la(e, n, l, r)),
      t !== null && ((l = ie()), je(t, e, r, l), _a(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Bt], delete n[go], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  if (nn !== null) {
    ...
    try {
      if (((xe.transition = null), (O = 16 > e ? 16 : e), nn === null))
        ...
        if (
          ((j = l), hn(), Ie && typeof Ie.onPostCommitFiberRoot == "function")
        )
          try {
...
ys = _i;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, vs, _i] },
  yt = {
...
const Rd =
  "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='86'%20height='26'%3e%3cg%20fill='none'%3e%3cpath%20fill='%2315202A'%20d='M5.008%2025c.555%200%20.832-.245.832-.736v-8c0-.235.117-.352.352-.352h4.8c2.603%200%204.699-.635%206.288-1.904%201.59-1.27%202.384-3.056%202.384-5.36%200-1.621-.41-2.987-1.232-4.096-.821-1.11-1.93-1.936-3.328-2.48-1.397-.544-2.981-.816-4.752-.816h-9.6c-.341%200-.512.203-.512.608V24.36c0%20.213.048.373.144.48.096.107.272.16.528.16h4.096zm5.216-13.088H6.288c-.17%200-.288-.048-.352-.144-.064-.096-.096-.25-.096-.464V5.832c0-.213.048-.363.144-.448.096-.085.25-.128.464-.128H10c1.195%200%202.144.277%202.848.832.704.555%201.056%201.376%201.056%202.464%200%201.045-.33%201.867-.992%202.464-.661.597-1.557.896-2.688.896zM27.856%2025c.32%200%20.544-.059.672-.176.128-.117.192-.315.192-.592v-22.4c0-.384-.17-.576-.512-.576h-4.576c-.341%200-.512.203-.512.608v22.464c0%20.235.053.405.16.512.107.107.288.16.544.16h4.032zm9.312%200c.235%200%20.4-.037.496-.112.096-.075.144-.197.144-.368V10.344c0-.107.037-.17.112-.192.075-.021.155.021.24.128l10.208%2014.336c.128.17.245.277.352.32.107.043.256.064.448.064H52.4a.66.66%200%2000.432-.144.455.455%200%2000.176-.368V1.736c0-.32-.139-.48-.416-.48H49.04c-.384%200-.576.192-.576.576v13.216c0%20.235-.053.352-.16.352-.085%200-.192-.085-.32-.256L38.576%201.736c-.15-.213-.277-.347-.384-.4-.107-.053-.288-.08-.544-.08h-3.872c-.384%200-.576.203-.576.608v22.592c0%20.363.213.544.64.544h3.328zm30.176.32c1.664%200%203.013-.288%204.048-.864a9.158%209.158%200%20002.672-2.24c.15-.17.256-.181.32-.032l.928%202.304c.192.341.47.512.832.512h1.024c.15%200%20.267-.043.352-.128a.476.476%200%2000.128-.352V13.736a.703.703%200%2000-.24-.56c-.16-.139-.39-.208-.688-.208l-8.544-.032c-.341%200-.512.15-.512.448v2.4c0%20.192.043.33.128.416.085.085.213.128.384.128h3.872c.235%200%20.352.096.352.288%200%20.085-.01.15-.032.192l-.064.928c-.235%201.045-.736%201.915-1.504%202.608-.768.693-1.792%201.04-3.072%201.04-1.685%200-2.976-.65-3.872-1.952-.896-1.301-1.344-3.435-1.344-6.4%200-2.837.427-4.907%201.28-6.208.853-1.301%202.101-1.952%203.744-1.952%201.259%200%202.283.363%203.072%201.088.79.725%201.29%201.643%201.504%202.752.043.192.096.325.16.4.064.075.181.112.352.112l4.224-.64c.277-.021.416-.15.416-.384%200-.192-.021-.352-.064-.48-.213-1.173-.752-2.277-1.616-3.312-.864-1.035-1.984-1.872-3.36-2.512-1.376-.64-2.896-.96-4.56-.96-2.176%200-4.096.501-5.76%201.504-1.664%201.003-2.955%202.432-3.872%204.288-.917%201.856-1.376%204.021-1.376%206.496%200%202.41.437%204.528%201.312%206.352.875%201.824%202.117%203.237%203.728%204.24%201.61%201.003%203.493%201.504%205.648%201.504z'/%3e%3cpath%20fill='%234C7BF3'%20d='M85.072%2025c.32%200%20.55-.059.688-.176.139-.117.208-.315.208-.592v-4c0-.363-.16-.544-.48-.544h-4.384a.498.498%200%2000-.368.144c-.096.096-.144.24-.144.432v4.064c0%20.448.235.672.704.672h3.776z'/%3e%3c/g%3e%3c/svg%3e";
function jd() {
  return R.jsx(R.Fragment, {
    children: R.jsxs("div", {
      className: " text-center pt-[4rem] flex flex-col space-y-10 m-auto",
      children: [
        R.jsx("div", {
          className: "w-16 m-auto object-none lg:w-28",
          children: R.jsx("img", { src: Rd, alt: "Logo Ping" }),
        }),
        R.jsxs("div", {
          className: "container space-y-4",
          children: [
            R.jsxs("h1", {
              className: "text-Neutral-Gray text-2xl lg:text-5xl font-[300]",
              children: [
                "We are launching",
                " ",
                R.jsx("span", {
                  className: "text-Neutral-VeryDarkBlue font-[700]",
                  children: "soon!",
                }),
              ],
            }),
            R.jsx("p", {
              className:
                "text-Neutral-VeryDarkBlue lg:text-lg text-sm font-[300]",
              children: "Subscribe and get notified",
            }),
          ],
        }),
      ],
...
const Od = "./assets/illustration-dashboard-DO_iwKaD.png";
function Md() {
  const [e, n] = Qn.useState(""),
    [t, r] = Qn.useState(""),
    [l, o] = Qn.useState(!0),
    i = () => {
      const s = /[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,8}(.[a-z{2,8}])?/g;
      s.test(e)
        ? (r(""), o(!0))
        : !s.test(e) && e !== ""
        ? (r("Please provide a valid email address"), o(!1))
        : (r(""), o(!0));
    },
    u = (s) => {
      n(s.target.value);
  ...
  return R.jsx("div", {
    ...
    children: R.jsxs("div", {
      className:
        "relative container lg:flex-row lg:justify-center gap-3 mt-12 m-auto w-[80%] max-w-[600px] flex flex-col",
      children: [
        R.jsx("input", {
          id: "email",
          type: "email",
          ...
          className: `border lg:w-[80%] border-${
            l ? "Secondary-PaleBlue" : "Secondary-LightRed"
        ...
        R.jsx("button", {
          ...
          id: "btn",
          className:
            "lg:w-[30%] rounded-full outline-none hover:opacity-50 focus:outline-none bg-Primary-Blue text-white font-[600]",
          children: "Notify Me",
        }),
        R.jsx("p", {
          id: "result",
          className:
            "text-Secondary-LightRed left-7 -top-5  text-xs italic  absolute",
          children: t,
        }),
      ],
    }),
...
function Dd() {
  return R.jsx(R.Fragment, {
    children: R.jsx("div", {
      className: "bg-white m-auto h-full w-full ",
      children: R.jsxs("div", {
        className: "container mx-auto",
        children: [
          R.jsx(jd, {}),
          R.jsx(Md, {}),
          R.jsx("div", {
            className: "m-auto w-[70%] max-w-[700px] mt-[4rem]",
            children: R.jsx("img", {
          ...
          R.jsxs("div", {
            children: [
              R.jsxs("div", {
                className:
                  "container flex gap-3 m-auto mt-[4rem] justify-center",
                children: [
                  R.jsx("svg", {
                    className:
                      "w-7 cursor-pointer hover:invert fill-Primary-Blue",
              ...
              R.jsx("p", {
                className:
                  "text-Neutral-Gray text-sm font-[300] text-center py-10",
                children: "© Copyright Ping. All rights reserved.",
              }),
            ],
          }),
        ],
...
Ql.createRoot(document.getElementById("root")).render(
  R.jsx(gc.StrictMode, { children: R.jsx(Dd, {}) })
);
